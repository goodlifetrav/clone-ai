 ...
 *   /tmp/benchmark/<slug>.html    — saved clone HTML
 *   /tmp/benchmark/<slug>.log     — [CLONE-DEBUG] stdout for that URL
 *   /tmp/benchmark/_summary.json  — per-URL signals + heuristic score
 *
